...
public abstract class SokobanMovable extends GameMovable implements Drawable, GameEntity {
	...
	public SokobanMovable(GameData data, int x, int y, String imagePath) {
		//this(data, x, y, imagePath, new SpeedVector(new Point(0,0), 0)) ; ///!\ A décommentariser après la màj du framework
		this(data, x, y, imagePath, new SpeedVector(new Point(0,0))) ; ///!\ A retirer après màj du framework
	}
